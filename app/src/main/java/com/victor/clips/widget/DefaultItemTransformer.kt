...
import com.victor.clips.widget.HeaderLayoutManager.Point
/*
 * -----------------------------------------------------------------
 * Copyright (C) 2018-2028, by Victor, All rights reserved.
 * -----------------------------------------------------------------
 * File: DefaultItemTransformer.java
 * Author: Victor
 * Date: 2018/9/12 10:08
 * Description: 
 * -----------------------------------------------------------------
 */
open class DefaultItemTransformer: NavigationToolBarLayout.ItemTransformer(), HeaderLayoutManager.ItemClickListener {
