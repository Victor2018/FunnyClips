...
import com.victor.clips.widget.HeaderLayoutManager.ItemChangeListener
import com.victor.clips.widget.HeaderLayoutManager.ScrollStateListener
import com.victor.clips.widget.HeaderLayoutManager.ItemClickListener
import com.victor.clips.widget.HeaderLayoutManager.HeaderChangeListener
import com.victor.clips.widget.HeaderLayoutManager.HeaderUpdateListener
import com.victor.clips.widget.HeaderLayoutManager.ItemDecoration
import com.victor.clips.widget.HeaderLayoutManager.HeaderChangeStateListener

/*
 * -----------------------------------------------------------------
 * Copyright (C) 2018-2028, by Victor, All rights reserved.
 * -----------------------------------------------------------------
 * File: NavigationToolBarLayout.java
 * Author: Victor
...
class NavigationToolBarLayout: CoordinatorLayout {
    ...
    private fun initBackgroundLayout(context: Context, layoutId: Int) {
        ...
        addHeaderChangeListener(object : HeaderLayoutManager.HeaderChangeListener {
