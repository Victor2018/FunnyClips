...
class WebConfig {
    companion object {
        ...
        const val FIND_FOLLOW_URL: String = "v4/tabs/follow?start=%d&num=%d&follow=false&startId=0&udid=d2807c895f0348a180148c9dfa6f2feeac0781b5&deviceModel=%s"//发现-关注
        const val FIND_CATEGORIES_URL: String = "v4/categories?udid=%s&deviceModel=%s"//发现-分类
        const val SEARCH_URL: String = "v1/search?&num=10&start=10&query=%s&udid=d2807c895f0348a180148c9dfa6f2feeac0781b5&deviceModel=%s"//搜索
