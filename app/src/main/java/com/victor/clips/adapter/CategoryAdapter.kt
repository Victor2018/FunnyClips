 ...
 * -----------------------------------------------------------------
 */
class CategoryAdapter(context: Context, listener: AdapterView.OnItemClickListener): BaseRecycleAdapter<CategoryReq, RecyclerView.ViewHolder>(context,listener) {
    val BIG_ITEM = 3
    val NORMAL_ITEM = 4
    val HEADER_ITEM = 5
    ...
    override fun onCreateContentVHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == NORMAL_ITEM) {
            return ContentViewHolder(mLayoutInflater!!.inflate(R.layout.rv_category_normal_cell, parent, false))
        }
