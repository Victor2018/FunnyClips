 ...
 * -----------------------------------------------------------------
 */
class SlideInRightAnimatorAdapter<T: RecyclerView.ViewHolder>
(var adapter: RecyclerView.Adapter<T>, var recyclerView: RecyclerView): AnimatorAdapter<T>(adapter,recyclerView) {
    ...
    override fun getAnimators(view: View): Array<Animator> {
        var anim = ObjectAnimator.ofFloat(view, TRANSLATION_X, mRecyclerView.getLayoutManager().getWidth().toFloat(), 0f)
        return arrayOf(anim)
    }
}